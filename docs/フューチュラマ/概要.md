...
<div class="mbx-snap">
	<img src="/Cartoon-Street/img/フューチュラマ.svg" width="240" height="180" alt="snap01" border="0" />
	<br class="mbx-clear" />
</div>

アメリカが生み出した最高のSFアニメです。「ザ・シンプソンズ」と同じスタッフが作成しているので、シンプソンズファンなら楽しめること間違いなしです。
